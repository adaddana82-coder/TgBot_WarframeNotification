...
namespace warframetgbot.Db.Notification.DbRelic
{
    ...
    public static class DataBaseHelperFissure
    {
        private static readonly SemaphoreSlim _semaphore = new SemaphoreSlim(1, 1);
        private static readonly string _dbPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Db\\Notification\\DbRelic\\WarframeRelic.db");
